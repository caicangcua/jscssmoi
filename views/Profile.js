...
ComApp.Store.Profile = function (params) {
    ...
    //var firstLoad=true,slider2, flugin$ = function () {
    //    (function ($) {
    //        var settings = [];
    ...
    //var viewModel = {
    //    slideMenu: function (e) {
    //        var mnu=$(e.event.target).closest('.btnstyle2');
    //        slider2.slideReveal((mnu.hasClass('menu-open')) ? "hide" : "show");
    //        mnu.toggleClass("menu-open menu-colapse");
    //    }
    //    ,tabs: [
    //        { text: "Dang Nhap" },
    //            { text: "Tao Moi" },
    ...
    //    ,viewShowing: function (e) {
    //        if (firstLoad) {
    //            firstLoad = false; flugin$(),slider2 = $(".slider").slideReveal({
    //                // width: 100,
    //                push: false,
    //                position: "right",
    //                speed: 300

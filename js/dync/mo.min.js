...
function Thanksfucking(actNo) {
    ...
    function init() {
        switch (actNo) {
            case '6': {
                /* Icon 6 */
                items = $('	<button class="icobutton icobutton--thumbs-up"><span class="fa fa-thumbs-up"></span></button>');
                var el6 = items[0], el6span = el6.querySelector('span');
                var scaleCurve6 = mojs.easing.path('M0,100 L25,99.9999983 C26.2328835,75.0708847 19.7847843,0 100,0');
                fuckACT=new Animocon(el6, {
                    tweens: [
                        // burst animation
                        new mojs.Burst({
                            parent: el6,
            ...
            case '14': {
                /* Icon 14 */
                items = $('<button class="icobutton icobutton--heart"><span class="fa fa-heart"></span></button>');
                var el14 = items[0], el14span = el14.querySelector('span');
                fuckACT=new Animocon(el14, {
                    tweens: [
                        // ring animation
                        new mojs.Shape({
                            parent: el14,
            ...
            case '16': {
                /* Icon 16 */
                items = $('<button class="icobutton icobutton--heart"><span class="camxuc imo1"></span></button>');
                var el16 = items[0], el16span = el16.querySelector('span');
